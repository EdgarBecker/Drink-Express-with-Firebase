...
import com.example.drink_express_mallorca.ui.KategorieWahlFragmentDirections

class KategorieWahlAdapter: RecyclerView.Adapter<KategorieWahlAdapter.viewHolder>() {
    ...
    override fun onBindViewHolder(holder: viewHolder, position: Int) {
        ...
        holder.cardView.setOnClickListener {
            Navigation.findNavController(holder.itemView)
                .navigate(KategorieWahlFragmentDirections.actionKategorieWahlFragmentToDetailFragment(getraenk.strDrink!!))
        }
    }
}